...
public class Main {
    ...
    public void runOneThread() {
        ...
        calculate(arr);
        System.out.println("Время выполнения однопоточного метода: " + (System.currentTimeMillis() - a));
    }
    ...
    public void runTwoThreads() {
        ...
        System.out.println("Время выполнения двухпоточного метода: " + (System.currentTimeMillis() - a));
    }
